...
var About = React.createClass({displayName: "About",
	render: function () {
		...
		return (
			React.createElement("div", {style: stil}, 
...
var Terms = React.createClass({displayName: "Terms",
	render: function () {
		...
		return (
			React.createElement("div", {style: stil2}, 

                React.createElement("h1", null, "Statement of Rights and Responsibilities"), 
                React.createElement("p", null, React.createElement("br", null), 
"This Statement of Rights and Responsibilities (\"Statement,\" \"Terms,\" or \"SRR\") derives from the Pentagram Principles, and is our terms of service that governs our relationship with users and others who interact with Pentagram, as well as Pentagram brands, products and services, which we call the “Pentagram Services” or “Services”. By using or accessing the Facebook Services, you agree to this Statement, as updated from time to time in accordance with Section 13 below. Additionally, you will find resources at the end of this document that help you understand how Pentagram works." + ' ' +
"Because Pentagram provides a wide range of Services, we may ask you to review and accept supplemental terms that apply to your interaction with a specific app, product, or service. To the extent those supplemental terms conflict with this SRR, the supplemental terms associated with the app, product, or service govern with respect to your use of such app, product or service to the extent of the conflict." + ' ' +
"Privacy", 
React.createElement("br", null), 
"Your privacy is very important to us. We designed our Data Policy to make important disclosures about how you can use Pentagram to share with others and how we collect and can use your content and information. We encourage you to read the Data Policy, and to use it to help you make informed decisions.", 
 React.createElement("br", null), React.createElement("br", null), 
"Sharing Your Content and Information", 
React.createElement("br", null), React.createElement("br", null), 
"You own all of the content and information you post on Pentagram, and you can control how it is shared through your privacy and application settings. In addition:" + ' ' +
...
"When you publish content or information using the Public setting, it means that you are allowing everyone, including people off of Pentagram, to access and use that information, and to associate it with you (i.e., your name and profile picture)." + ' ' +
"We always appreciate your feedback or other suggestions about Pentagram, but you understand that we may use your feedback or suggestions without any obligation to compensate you for them (just as you have no obligation to offer them).", 
React.createElement("br", null), React.createElement("br", null), 
"Safety", 
React.createElement("br", null), React.createElement("br", null), 
"We do our best to keep Facebook safe, but we cannot guarantee it. We need your help to keep Pentagram safe, which includes the following commitments by you:" + ' ' +
"You will not post unauthorized commercial communications (such as spam) on Pentagram." + ' ' +
"You will not collect users' content or information, or otherwise access Pentagram, using automated means (such as harvesting bots, robots, spiders, or scrapers) without our prior permission." + ' ' +
"You will not engage in unlawful multi-level marketing, such as a pyramid scheme, on Pentagram." + ' ' +
...
"You will not do anything that could disable, overburden, or impair the proper working or appearance of Facebook, such as a denial of service attack or interference with page rendering or other Pentagram functionality." + ' ' +
"You will not facilitate or encourage any violations of this Statement or our policies.", 
React.createElement("br", null), React.createElement("br", null), 
"Registration and Account Security", 
React.createElement("br", null), React.createElement("br", null), 
"Pentagram users provide their real names and information, and we need your help to keep it that way. Here are some commitments you make to us relating to registering and maintaining the security of your account:" + ' ' +
"You will not provide any false personal information on Pentagram, or create an account for anyone other than yourself without permission." + ' ' +
"You will not create more than one personal account." + ' ' +
"If we disable your account, you will not create another one without our permission." + ' ' +
"You will not use your personal timeline primarily for your own commercial gain, and will use a Pentagram Page for such purposes." + ' ' +
"You will not use Pentagram if you are under 13." + ' ' +
"You will not use Pentagram if you are a convicted sex offender." + ' ' +
...
"You will not post content or take any action on Pentagram that infringes or violates someone else's rights or otherwise violates the law." + ' ' +
"We can remove any content or information you post on Pentagram if we believe that it violates this Statement or our policies." + ' ' +
        ...
        React.createElement("nav", {className: "navbar navbar-default"}, 
          React.createElement("div", {className: "container-fluid"}, 
              React.createElement("ul", {className: "nav navbar-nav"}, 
                  ...
                  React.createElement("li", null, React.createElement(Link, {to: "app"}, "Login")), 
...
var Login = React.createClass({displayName: "Login",
	...
	render: function() {
		...
		return (
			React.createElement("div", {className: "LoginForm", style: moto}, 
				React.createElement("form", null, 
					...
					React.createElement("input", {type: "Submit", 
                           value: "Login", 
                           onClick: this.formSubmitHandler}), React.createElement("br", null), "Pentagram @ 2016", React.createElement("br", null)
				)
			)
		);
	}
...
var Register = React.createClass({displayName: "Register",
	...
	render: function() {
		...
		return (
			React.createElement("div", {className: "RegisterForm", style: moto}, 
				React.createElement("form", null, 
                    React.createElement("h1", null, "Create a new account"), 
                    React.createElement("input", {placeholder: "Username", 
                           type: "text", 
                           name: "username", 
                           onChange: this.userChangeHandler}), " ", React.createElement("br", null), React.createElement("br", null), 
					...
					React.createElement("input", {type: "Submit", 
						   value: "Sign Up", 
						   onClick: this.formSubmitHandler}), React.createElement("br", null), 
                    "By clicking Sign Up, you agree to our ", React.createElement(Link, {to: "terms"}, "terms"), " and that ", React.createElement("br", null), 
                    "you have read our Data Policy, including our Cookie Use.", React.createElement("br", null)
				)
			)
		);
	}
			...
			React.createElement("div", {className: "container"}, 
				React.createElement("div", {className: "row"}, 
					React.createElement("div", {className: "col-md-5"}, 
                        ...
                        React.createElement("span", {className: "like-icon glyphicon glyphicon-thumbs-up", onClick: self.onLikeHandler}), 
...
var routes = (
  React.createElement(Route, {name: "app", path: "/", handler: require('./components/app')}, 
    ...
    React.createElement(Route, {name: "about", handler: require('./components/about/aboutPage')}), 
      React.createElement(Route, {name: "terms", handler: require('./components/about/termPage')}), 
      React.createElement(Route, {name: "main", handler: require('./components/mainPage')}), 
...
},{"./components/about/aboutPage":197,"./components/about/termPage":198,"./components/app":199,"./components/loginPage":201,"./components/mainPage":202,"./components/notFoundPage":203,"./components/registerPage":204,"./components/singlePhoto":205,"react":196,"react-router":27}]},{},[206]);
